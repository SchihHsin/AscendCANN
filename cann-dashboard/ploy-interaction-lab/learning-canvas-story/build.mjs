...
.story-deck .problem-bottom span:last-child{background:#7561cf;border-color:#7561cf;color:#fff}
.story-deck .problem-bottom::before{content:'→';display:flex;align-items:center;justify-content:center;width:2.5vw;height:2.5vw;min-width:30px;min-height:30px;border-radius:50%;background:#e8e2ff;color:#7561cf;font-size:1.5em;font-weight:650}
...
const problem=`<section class="slide s-gray" data-title="AI 加速了开发，也带来了知识内化的新问题"><div class="head"><div class="head-l"><div class="brand"><span class="ttl">AI 加速了开发，也带来了知识内化的新问题</span></div><div class="subttl">问题陈述</div></div>${chapterTabs('P')}</div><div class="body-area"><div class="problem-wrap"><h1 class="problem-title">AI 加速了开发，也带来了知识内化的新问题</h1><p class="problem-copy">从“查找—理解—实践”的传统路径，到“描述目标—生成—验证”的 AI 开发方式，学习发生的方式正在变化。我们需要重新设计知识进入任务的时机。</p><div class="problem-bottom"><span>从“完成当前任务”到“形成可迁移的理解”</span><span>接下来：让学习进入任务过程</span></div></div></div><div class="foot">设计背景 · 学习不应只发生在任务之外</div></section>`;
const rules=[
