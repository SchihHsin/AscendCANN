...
const cover=`<section class="slide s-cover" data-title="学习发生在任务中，内容留在可管理的画布里"><div class="cv-bg"></div><div class="cv-overlay"></div><div class="cv-inner"><div class="cv-top"><img class="cv-logo" src="../../../Ascendlogo.svg" alt="昇腾"></div><div class="cv-main"><div class="cv-kicker">SPATIAL LEARNING WORKSPACE</div><h1 class="cv-name">学习发生在任务中<span>画布随过程展开</span></h1><p class="cv-lead">主动学习与开发中学习的两条完整故事线<br>每一步：用户操作 · 界面响应 · 设计点 · 画布管理</p><div class="cover-links"><a href="#2">主动学习 →</a><a href="#13">开发中学习 →</a><a href="#24">共用机制 →</a></div></div><div class="cv-bot"><span>10 张关键状态图 · 24 页 · 大图与设计说明配对</span><span>设计提案 / 所有执行与数据均为模拟</span></div></div></section>`;
const rules=[
