...
const extraHero=()=>`<section class="slide s-glow hero-step" data-template="glow-design-point" data-title="B6 · 任务中试改 · 大图"><div class="glow"></div><div class="hero-inner"><header class="hero-heading"><div><div class="step-meta">开发中学习 / B6 / 任务中试改</div><h1>在原任务现场先试改，再决定是否继续</h1></div><a href="#29">本步设计说明 →</a></header><button class="hero-shot" data-enlarge="images/B6-task-try.png" aria-label="查看 B6 任务中试改原图"><img src="images/B6-task-try.png" alt="在原任务现场先试改，再决定是否继续" decoding="async"></button><div class="hero-foot"><span>选中代码 · 参数试改 · 运行练习 · 结果关联</span><span>设计示意 · 点击图片放大</span></div></div></section>`;
...
const cover=`<section class="slide s-cover" data-title="让学习在合适的时机发生"><div class="cv-bg"></div><div class="cv-overlay"></div><div class="cv-inner"><div class="cv-top"><img class="cv-logo" src="../../../Ascendlogo.svg" alt="昇腾"></div><div class="cv-main"><div class="cv-kicker">SPATIAL LEARNING WORKSPACE</div><h1 class="cv-name"><span class="cv-line">让学习在合适的时机</span><span>发生</span></h1><p class="cv-lead">主动学习与开发中学习的两条完整故事线<br>每一步：用户操作 · 界面响应 · 设计点 · 画布管理</p><div class="cover-links"><a href="#2">主动学习 →</a><a href="#13">开发中学习 →</a><a href="#30">共用机制 →</a></div></div><div class="cv-bot"><span>10 张关键状态图 · 30 页 · 大图与设计说明配对</span></div></div></section>`;
const rules=[
...
const sections=[cover.replace('href="#2"','href="#6"').replace('href="#13"','href="#17"'),...introPages(chapterTabs)];
