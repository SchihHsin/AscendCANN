...
>本节内容为使用高阶API进行矩阵乘法的编程指导。使用高阶API进行实际的矩阵编程时，需要通过[API参考](矩阵计算-48.md)确认接口支持的产品型号。
...
![](figures/矩阵编程逻辑位置示意图-29.png)

## 数据格式

在完成Matmul矩阵乘法时，主要涉及到两种分形格式ND和[NZ](数据排布格式.md#li19960204116136)。
