...
-   MIX模式（包含矩阵计算和矢量计算）的设置规则请参考[MIX场景核数设置规则](算子实现-11.md#zh-cn_topic_0000001644252364_li4790115115920)。
