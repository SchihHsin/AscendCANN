...
本节介绍\_\_NPU\_ARCH\_\_版本号为300x的硬件架构和其功能说明，其中300代表IP核编号，x表示同一个IP核的配置版本号。对应的产品型号为：
...
-   Channel merge（S8和U8数据类型）
    ...
    ![](figures/Fixpipe_int8-channel_merge-12.png)
...
-   Channel merge（S4和U4数据类型）
    ...
    ![](figures/Fixpipe_int4_channel_merge-13.png)
...
-   FP32 Channel split：
    ...
    ![](figures/Fixpipe_F32_channel_split-14.png)
...
-   核内同步
    ...
    ![](figures/0000000-核内同步最终版-15.png)
