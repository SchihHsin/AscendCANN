...
| B1 | L1 Buffer |
| B2 | L0B Buffer |
| C1 | Atlas 训练系列产品，Unified Buffer。
...
| CO1 | L0C Buffer |
| CO2 | Atlas 训练系列产品，Unified Buffer。
Atlas 推理系列产品AI Core，Unified Buffer。
...
| TSCM | L1 Buffer |
| SPM | Atlas 训练系列产品，L1 Buffer。
Atlas 推理系列产品AI Core，L1 Buffer。
Atlas A2 训练系列产品/Atlas A2 推理系列产品，Global Memory。
Atlas A3 训练系列产品/Atlas A3 推理系列产品，Global Memory。 |
| C2PIPE2GM | Atlas A2 训练系列产品/Atlas A2 推理系列产品，Fixpipe Buffer。
