...
-   \_\_aicore\_\_ inline void SetTensorAWithCopy\(const GlobalTensor<SrcAT\>& gm, const LocalTensor<SrcAT\> &leftMatrix, bool isTransposeA = false\);
-   \_\_aicore\_\_ inline void SetTensorBWithCopy\(const GlobalTensor<SrcBT\>& gm, const LocalTensor<SrcBT\> &rightMatrix, bool isTransposeB = false\);
