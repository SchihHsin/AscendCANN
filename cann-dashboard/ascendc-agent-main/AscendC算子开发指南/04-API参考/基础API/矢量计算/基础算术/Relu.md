...
![](figures/zh-cn_formulaimage_0000002502574470.png)
...
Atlas A2 训练系列产品/Atlas A2 推理系列产品，支持的数据类型为：half/int32_t/float
Atlas A3 训练系列产品/Atlas A3 推理系列产品，支持的数据类型为：half/int32_t/float
Atlas 200I/500 A2 推理产品，支持的数据类型为：half/int32_t/float |
