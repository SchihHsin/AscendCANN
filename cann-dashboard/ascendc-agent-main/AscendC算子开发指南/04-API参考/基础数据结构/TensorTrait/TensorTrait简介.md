...
| 参数名 | 描述 |
| --- | --- |
| T | 只支持如下基础数据类型：int4b_t、uint8_t、int8_t、int16_t、uint16_t、bfloat16_t、int32_t、uint32_t、int64_t、uint64_t、float、half 。
...
| LayoutType | Layout数据类型，默认为空类型，即Layout<Shape<>, Stride<>>。
