...
![](figures/zh-cn_formulaimage_0000002534493883.png)
...
![](figures/zh-cn_formulaimage_0000002534413847.png)
...
![](figures/zh-cn_formulaimage_0000002502574036.png)

![](figures/zh-cn_formulaimage_0000002534413853.png)

![](figures/zh-cn_formulaimage_0000002502733840.png)

![](figures/zh-cn_formulaimage_0000002534413855.png)

其中\(d<sub>0</sub>, d<sub>1</sub>, ..., d<sub>n</sub>\)为Shape，\(s<sub>0</sub>, s<sub>1</sub>, ..., s<sub>n</sub>\)为Stride，delinearize公式展开如下：

![](figures/zh-cn_formulaimage_0000002502574030.png)
...
| 参数名 | 输入/输出 | 描述 |
| --- | --- | --- |
| coord | 输入 | Std::tuple结构类型，用于表示张量在不同维度上的坐标值。
输入的数据类型支持size_t和Std::Int。 |
| layout | 输入 | 输入的Layout对象。
输入的数据类型支持size_t和Std::Int。 |
