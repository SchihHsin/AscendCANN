...
![](figures/zh-cn_formulaimage_0000002534414295.png)

其中GELU激活函数的计算公式如下：

![](figures/zh-cn_formulaimage_0000002534414303.png)

上述公式中的erf为误差函数：![](figures/zh-cn_formulaimage_0000002534494329.png)

误差函数没有解析表达式，按照业界普遍使用的tanh近似表达式：![](figures/zh-cn_formulaimage_0000002534494343.png)

将GELU近似公式代入可得GeGLU表达式为：

![](figures/zh-cn_formulaimage_0000002534414299.png)
