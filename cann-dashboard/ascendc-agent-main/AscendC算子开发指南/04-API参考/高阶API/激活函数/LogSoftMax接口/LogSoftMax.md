...
![](figures/zh-cn_formulaimage_0000002534494503.png)

![](figures/zh-cn_formulaimage_0000002502734462.png)
...
| sharedTmpBuffer | 输入 | 临时缓存。临时空间大小BufferSize的获取方式请参考LogSoftMax Tiling。
类型为LocalTensor，支持的TPosition为VECIN/VECCALC/VECOUT。 |
