...
Ascend C提供一组Matmul  [Tiling](基础知识.md#zh-cn_topic_0000001622194138_section68451031218)  API，方便用户获取[Matmul kernel计算](Matmul使用说明.md#li5878185413338)时所需的Tiling参数。用户只需要传入A/B/C矩阵的Position位置、Format格式和DType数据类型等信息，调用API接口，即可获取到[Init](Init-49.md)中TCubeTiling结构体中的相关参数。
