...
![](figures/zh-cn_formulaimage_0000002502734442.png)
...
| --- | --- | --- | --- | --- |
| half | int32_t | half | float | <br/>- Atlas A3 训练系列产品/Atlas A3 推理系列产品<br/>- Atlas A2 训练系列产品/Atlas A2 推理系列产品 |
| bfloat16_t | int32_t | bfloat16_t | float | <br/>- Atlas A3 训练系列产品/Atlas A3 推理系列产品<br/>- Atlas A2 训练系列产品/Atlas A2 推理系列产品 |
...
4.  完成卷积反向操作。
    ...
    调用[Iterate](Iterate-87.md)完成单次迭代计算，叠加while循环完成单核全量数据的计算。Iterate方式，可以自行控制迭代次数，完成所需数据量的计算。
