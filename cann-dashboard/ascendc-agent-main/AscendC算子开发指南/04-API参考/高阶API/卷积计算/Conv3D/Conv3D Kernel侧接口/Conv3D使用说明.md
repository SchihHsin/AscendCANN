...
![](figures/zh-cn_formulaimage_0000002502733880.png)
...
| --- | --- | --- | --- | --- |
| half | half | half | half | <br/>- Atlas A3 训练系列产品/Atlas A3 推理系列产品<br/>- Atlas A2 训练系列产品/Atlas A2 推理系列产品 |
| bfloat16_t | bfloat16_t | float | bfloat16_t | <br/>- Atlas A3 训练系列产品/Atlas A3 推理系列产品<br/>- Atlas A2 训练系列产品/Atlas A2 推理系列产品 |
...
4.  完成3D卷积操作。
    ...
    调用[IterateAll](IterateAll-65.md)完成单核上所有数据的计算。
