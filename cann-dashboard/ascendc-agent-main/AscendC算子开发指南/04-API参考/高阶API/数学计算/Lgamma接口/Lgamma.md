...
![](figures/zh-cn_formulaimage_0000002502734472.png)

![](figures/zh-cn_formulaimage_0000002502574664.png)
...
类型为LocalTensor，支持的TPosition为VECIN/VECCALC/VECOUT。
用于Lgamma内部复杂计算时存储中间变量，由开发者提供。
临时空间大小BufferSize的获取方式请参考GetLgammaMaxMinTmpSize。 |
