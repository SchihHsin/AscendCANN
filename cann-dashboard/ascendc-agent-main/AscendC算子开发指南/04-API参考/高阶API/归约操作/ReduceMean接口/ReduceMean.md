...
| pattern | 用于指定ReduceMean计算轴，包括Reduce轴和Normal轴。pattern由与向量维度数量相同的A、R字母组合形成，字母A表示Normal轴，R表示Reduce轴。例如，AR表示对二维向量进行ReduceMean计算：第一维是Normal轴，第二维是Reduce轴，即对第二维数据计算求平均值。
