...
> **完整方法论**: [reduction-ops-methodology.md](reduction-ops-methodology.md)
...
| 分支 | 条件 | 难度 | 详细文档 |
|-----|------|------|---------|
| **AR-全载** | A0=1, R ≤ threshold | ★★ | [reduction-ops-ar-fullload.md](reduction-ops-ar-fullload.md) |
| **AR-Col-Split** | A0=1, R > threshold | ★★★ | [reduction-ops-ar-colsplit.md](reduction-ops-ar-colsplit.md) |
| **ARA-全载** | A0>1, R ≤ R_max | ★★★ | [reduction-ops-ara-fullload.md](reduction-ops-ara-fullload.md) |
| **ARA-Row-Split** | A0>1, R > R_max | ★★★★ | [reduction-ops-ara-rowsplit.md](reduction-ops-ara-rowsplit.md) |
...
- **完整方法论**: [reduction-ops-methodology.md](reduction-ops-methodology.md)
- **分支实现**:
  - [AR-全载](reduction-ops-ar-fullload.md)
  - [AR-Col-Split](reduction-ops-ar-colsplit.md)
  - [ARA-全载](reduction-ops-ara-fullload.md)
  - [ARA-Row-Split](reduction-ops-ara-rowsplit.md)
- **相关参考**:
